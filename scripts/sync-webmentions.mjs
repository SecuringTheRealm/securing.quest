 ...
 *
 * Fetches recent webmentions for securing.quest and merges them into
 * src/data/webmentions.json, keyed by target URL. Deduplicates by wm-id.
 *
 * Usage: WEBMENTION_IO_TOKEN=xxx bun scripts/sync-webmentions.mjs
 */
...
const DOMAIN = 'securing.quest'
const API_BASE = 'https://webmention.io/api/mentions.jf2'
const PER_PAGE = 100

const __dirname = fileURLToPath(new URL('.', import.meta.url))
const DATA_FILE = join(__dirname, '..', 'src', 'data', 'webmentions.json')
